...
// Error Type 3 and 16
extern void CheckSameVarNameInSymbolTable(char *varname, int lineno,
                                          SymbolTableHead *table, int Name);

extern void CheckSameFunNameInSymbolTable(char *funname, int lineno,
                                          SymbolTableHead *table);

extern void CheckSameFieldNameInStruct(char *fieldname, int lineno, Type *TP,
                                       int Name);

extern void CheckSameVarNameInStructTypeTable(char *varname, int lineno,
                                              StructTypeTableHead *table,
                                              int Name);

extern void CheckSameVarNameInParamList(char *varname, int lineno,
                                        ParamList *PL);
