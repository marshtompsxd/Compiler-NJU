...
extern void InsertItemIntoSymbolTable(SymbolTableEntry *item,
                                      SymbolTableHead *table);

extern void InsertItemIntoStructTypeTable(StructTypeTableEntry *item,
                                          StructTypeTableHead *table);

extern Type *LookUpForStructTypeFromStructTypeTable(char *structname,
                                                    StructTypeTableHead *table);

extern Type *LookUpForStructType(char *structname);

extern SymbolTableEntry *LookUpForVarDefFromSymbolTable(char *varname,
                                                        SymbolTableHead *table);

extern SymbolTableEntry *LookUpForVarDef(char *varname);

extern SymbolTableEntry *LookUpForFunDefFromSymbolTable(char *funname,
                                                        SymbolTableHead *table);
